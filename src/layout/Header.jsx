                    ...
                    <div className="flex items-center justify-between h-20">
                        <div className="flex items-center">
                            ...
                            <div className="hidden md:block">
                                ...
                                <a href="#" className="bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium">INSTAFAKE</a>
                                <div>
                                    <div className="mt-1 relative rounded-full shadow-full">
                                        <input type="text" name="Search" id="search" className="rounded-full h-9  bg-gray-300 focus:ring-indigo-500 focus:border-indigo-500  w-max pl-7 pr-12 sm:text-sm border-gray-400" placeholder="Search"/>
                        ...
                        <div className="hidden md:block">
                            <div className="ml-4 flex items-center md:ml-6">
                                ...
                                <button className="bg-gray-800 p-1 rounded-full text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
                                    <svg lassName="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
