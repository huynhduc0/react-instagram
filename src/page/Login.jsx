...
import './login.scss';
import { fetchJSON } from '../utilities/api.js';
import { setToken, setRole } from '../utilities/localToken.js';
     ...
     <div className="App">
       <form onSubmit={this.login}>
         ...
         <div className="inputGroup inputGroup1">
           ...
           <input type="text" onChange={this.onUsernameChange} id="loginEmail" maxlength="254" />
           <p className="helper helper1">username</p>
         </div>
         <div className="inputGroup inputGroup2">
           <label for="loginPassword" id="loginPasswordLabel">Password</label>
           <input type="password" onChange={this.onPasswordChange} id="loginPassword" />
